  ...
  return (
    <div dir="rtl" className="mx-auto w-full max-w-[390px] px-5 pt-24 pb-28 font-[Cairo] bg-[#ece7de] min-h-screen relative overflow-hidden">
      ...
      <div className="fixed top-6 left-5 right-5 flex items-center justify-between z-[45] pointer-events-none">
        ...
        <div className="cut-crystal-capsule px-5 h-10 rounded-full shadow-md border-[rgba(43,26,16,0.14)] flex items-center justify-center pointer-events-auto">
      ...
      <div className="space-y-4 relative z-10">
        ...
        <div className="cut-crystal-panel rounded-[26px] p-5 space-y-4">
        ...
        <div className="cut-crystal-panel rounded-[26px] p-5 text-center relative overflow-hidden">
